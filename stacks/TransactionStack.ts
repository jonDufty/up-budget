    ...
    job: {
      function: {
        ...
        environment: {
          ...
          "TRANSACTION_UPBANK_PAGE_SIZE": process.env.TRANSACTION_UPBANK_PAGE_SIZE!,
          "TRANSACTION_UPBANK_PAGINATE": process.env.TRANSACTION_UPBANK_PAGINATE!,
          "TRANSACTION_UPBANK_TRANSACTION_LIMIT": process.env.TRANSACTION_UPBANK_TRANSACTION_LIMIT!,
          "TRANSACTION_DATABASE_NAME": process.env.TRANSACTION_DATABASE_NAME!,
          "TRANSACTION_DATABASE_USERNAME": process.env.TRANSACTION_DATABASE_USERNAME!,
          "TRANSACTION_DATABASE_HOST": process.env.TRANSACTION_DATABASE_HOST!,
          "TRANSACTION_DATABASE_PASSWORD": process.env.TRANSACTION_DATABASE_PASSWORD!
        }
      }
    }
  })
